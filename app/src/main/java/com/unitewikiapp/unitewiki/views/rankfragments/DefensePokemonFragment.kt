...
import com.unitewikiapp.unitewiki.databinding.FragmentDefensePokemonBinding
...
@AndroidEntryPoint
class DefensePokemonFragment : Fragment() {

    private var _binding: FragmentDefensePokemonBinding? = null
    ...
    override fun onCreateView(
        ...
        _binding = FragmentDefensePokemonBinding.inflate(inflater,container,false)
        binding.apply {
            defenseRecyclerview.adapter = adapter
            defenseRecyclerview.layoutManager = LinearLayoutManager(activity)
        }
    ...
    private fun subscribeUi() {
        viewModel.fetchRanks(Constants.DEFENSE_RANKING)
